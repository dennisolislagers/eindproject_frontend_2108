...
function Dropbox ({className="selectbox-menu", htmlFor, header, register, name, id, choice, onChange, value1, title1, value2, title2,value3, title3,value4, title4,value5, title5, value6, title6}) {
    return (
            <>
